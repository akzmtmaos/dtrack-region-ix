...
const DocumentDetailModal: React.FC<DocumentDetailModalProps> = ({
  ...
  /** Storage path in Supabase; required for signed download URL. */
            ...
            {showsAttachmentFilename && !hasStoragePath && (
              <div className="flex items-start gap-3">
                ...
                <p className="text-[11px] leading-snug flex-1" style={{ color: textSecondary }}>
                  A filename is shown, but no file path is stored. Open <strong>Edit</strong> and attach the file again so it can be downloaded.
                </p>
              </div>
            )}
            {attachmentError && (
