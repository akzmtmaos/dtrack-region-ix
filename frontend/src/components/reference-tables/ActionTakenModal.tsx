            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <input
                    type="text"
                    name="actionTakenCode"
                    value={formData.actionTakenCode}
                    onChange={handleChange}
                    placeholder="Enter action taken code"
                    className="w-full px-2.5 py-1.5 text-xs rounded-md outline-none transition-colors"
                    style={{
                      backgroundColor: inputBg,
                      border: `1px solid ${errors.actionTakenCode ? '#ef4444' : inputBorder}`,
                      color: textPrimary
                    }}
                    onFocus={(e) => e.target.style.borderColor = '#3ecf8e'}
                    onBlur={(e) => e.target.style.borderColor = errors.actionTakenCode ? '#ef4444' : inputBorder}
                  />
                  {errors.actionTakenCode && (
                    <p className="mt-1 text-xs" style={{ color: '#ef4444' }}>{errors.actionTakenCode}</p>
                  )}
                </div>
              </div>
