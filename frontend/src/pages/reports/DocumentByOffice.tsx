...
const DocumentByOffice: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handlePrint = () => {
      ...
      const printContent = `
        ...
        <html>
          <head>
            <title>Document By Office - Report</title>
            <style>
              @media print {
                @page { margin: 1cm; }
          ...
          <body>
            ...
            <h1>Document By Office - Report</h1>
            <table>
              <thead>
                <tr>
    ...
    const handleExportToExcel = () => {
      // Create CSV content
      const headers = ['Name Of Office', 'Doc Type', 'Subject', 'Date', 'Action Officer', 'Action Taken', 'Document Control No.', 'Remarks', 'Status']
      ...
      link.setAttribute('download', `document_by_office_${new Date().toISOString().split('T')[0]}.csv`)
    ...
    const handleExportToWord = () => {
      ...
      link.setAttribute('href', url)
      link.setAttribute('download', `document_by_office_${new Date().toISOString().split('T')[0]}.doc`)
      link.style.visibility = 'hidden'
      document.body.appendChild(link)
      link.click()
      document.body.removeChild(link)
...
export default DocumentByOffice