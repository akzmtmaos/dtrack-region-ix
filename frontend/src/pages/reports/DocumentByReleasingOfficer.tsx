...
const DocumentByReleasingOfficer: React.FC = () => {
  ...
  const handlePrint = () => {
    ...
    const printContent = `
      ...
      <html>
        <head>
          <title>Document By Releasing Officer - Report</title>
          <style>
            @media print {
              @page { margin: 1cm; }
        ...
        <body>
          ...
          <h1>Document By Releasing Officer - Report</h1>
          <table>
            <thead>
              <tr>
  ...
  const handleExportToExcel = () => {
    ...
    link.setAttribute('download', `document_by_releasing_officer_${new Date().toISOString().split('T')[0]}.csv`)
  ...
  const handleExportToWord = () => {
    ...
    link.setAttribute('href', url)
    link.setAttribute('download', `document_by_releasing_officer_${new Date().toISOString().split('T')[0]}.doc`)
    link.style.visibility = 'hidden'
    document.body.appendChild(link)
    link.click()
    document.body.removeChild(link)
  ...
  return (
    <div className="pt-4 pb-8">
      ...
      }`}>Document By Releasing Officer</h1>
...
export default DocumentByReleasingOfficer