...
const DocumentByOfficeControlNo: React.FC = () => {
    ...
    <div className="pt-4 pb-8">
      ...
      >
        ...
        <tbody className={`divide-y ${
          ...
          {loading ? (
            <tr>
              <td colSpan={10} className={`px-4 py-2 text-center text-xs ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
                Loading...
              </td>
            </tr>
          ) : documents.length === 0 ? (
            <tr>
              <td colSpan={10} className={`px-4 py-2 text-center text-xs ${theme === 'dark' ? 'text-white' : 'text-gray-500'}`}>
                No documents found
              </td>
            </tr>
          ) : (
...
export default DocumentByOfficeControlNo