    ...
    <div className="pt-4 pb-8">
      ...
      >
        ...
        <tbody className={`divide-y ${
          ...
          {loading ? (
            <tr>
              <td colSpan={10} className={`px-6 py-8 text-center text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
                Loading...
              </td>
            </tr>
          ) : documents.length === 0 ? (
            <tr>
              <td colSpan={10} className={`px-6 py-8 text-center text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-500'}`}>
                No documents found
              </td>
            </tr>
          ) : (
