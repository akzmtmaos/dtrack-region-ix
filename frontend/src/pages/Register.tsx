      ...
      <div className="max-w-md w-full space-y-6 p-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className={labelClass}>Office representative</label>
              <input
                type="text"
                value={officeRepresentative}
                onChange={(e) => setOfficeRepresentative(e.target.value)}
        ...
        <p className="text-center text-xs text-gray-500">
          © 2024 Department of Health. All rights reserved.
        </p>
      </div>
    </div>
  )
